...
const ServiceRoutes = () => {
  ...
  return (
    <div className="card shadow bg-light border-1 mb-4 p-4">
      {requestUrl && (
        <p className="bg-light text-primary p-1 fs-5 rounded">{requestUrl}</p>
      )}

      <div className="d-flex flex-row gap-5 align-items-end">
        <div className="form-group w-25">
          <label htmlFor="route" className="form-label text-dark fs-5">
            Service Route
          </label>
          <input
            type="text"
        ...
        <div className="form-group w-25">
          <label htmlFor="service" className="text-dark form-label fs-5">
            Select Service
          </label>
          <select
            name="services"
